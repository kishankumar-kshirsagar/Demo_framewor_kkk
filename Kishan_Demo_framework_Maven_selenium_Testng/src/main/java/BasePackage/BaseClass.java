...
public class BaseClass extends TestBase {
	...
	public void beforeMethod(Method method) throws IOException {
		...
		webDriver.get(url);
		webDriver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10)); // applicable to all the elements.
		webDriver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(20));
		SetDates();

		ExtentTestManager
				.startTest("Testcase Name: " + method.getName(), method.getAnnotation(Test.class).description())
				.assignAuthor("Kishankumar").assignCategory("LeadDistro Regression TestCases");
		System.out.println("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
